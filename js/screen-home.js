...
function HomeScreen(p){
  ...
  return React.createElement("div",{style:{padding:"18px",maxWidth:"480px",margin:"0 auto",animation:"fadeIn .3s ease"}},
    ...
    React.createElement("button",{onClick:function(){p.onGo("subjects");},style:bs("linear-gradient(135deg,"+GOLD+","+ORANGE+")",{width:"100%",fontSize:"16px",padding:"14px",borderRadius:"14px",marginBottom:"10px",boxShadow:"0 4px 20px rgba(255,209,102,.3)",color:BG})},"Start Practising"),
    React.createElement("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr 1fr 1fr",gap:"8px",marginBottom:"12px"}},
      [["🏆","Leaderboard","leaderboard"],["🎖️","Badges","achievements"],["📋","History","history"],["📊","Dashboard","parent"]].map(function(item){
    ...
    React.createElement("div",{style:cs({marginBottom:"10px"})},
      React.createElement("div",{style:{color:MUTED,fontSize:"10px",fontWeight:"700",letterSpacing:"1px",marginBottom:"9px"}},"YEAR GROUP"),
...
function SubjectsScreen(p){
  return React.createElement("div",{style:{padding:"18px",maxWidth:"480px",margin:"0 auto",animation:"fadeIn .3s ease"}},
    React.createElement("div",{style:{display:"flex",alignItems:"center",gap:"12px",marginBottom:"20px"}},
      ...
      React.createElement("h2",{style:{color:WHITE,fontSize:"19px",fontWeight:"800",margin:0}},"Choose a Subject")
    ),
...
function ModesScreen(p){
  ...
  return React.createElement("div",{style:{padding:"18px",maxWidth:"480px",margin:"0 auto",animation:"fadeIn .3s ease"}},
    React.createElement("div",{style:{marginBottom:"14px"}},React.createElement(BackBtn,{onClick:p.onBack})),
